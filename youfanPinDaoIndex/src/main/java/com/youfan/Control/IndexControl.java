...
import com.youfan.hystrix.ProductTypeServicehy;
...
//            orderMsgOutService.sendordermsg("test");
            ...
            DateFormat datefoarmt = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss:SSS");
            String nowdatestring = datefoarmt.format(new Date());
            String tradenumber = UUID.randomUUID()+nowdatestring;
